...
glodap = glodap.rename(columns={'G2expocode':'Expo Code',
                                ...
                                'G2hour':'Hour',
                                'G2minute':'Minute',
                                'G2latitude':'Latitude (ºN)',
                                'G2longitude':'Longitude (ºE)',
                                'G2depth':'Depth (m)',
                                'G2theta':'Theta (ºC)',
                                'G2salinity':'Salinity (PSU)',
                                'G2oxygen':'Oxygen (μmol/kg)',
                                'G2nitrate':'Nitrate (μmol/kg)',
                                'G2silicate':'Silicate (μmol/kg)',
                                'G2phosphate':'Phosphate (μmol/kg)',
                                'G2talk':'TA (μmol/kg)',
                                'G2phtsinsitutp':'pH'})
...
glodap.to_csv(filepath + output_file_name)